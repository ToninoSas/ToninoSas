...
Interessato in AI. Argomento tesi triennale: "Prevedere le allucinazioni nel tool calling di un agente LLM tramite l’analisi del residual stream" 
...
- **Strumenti & OS:** Git, Postman, Linux, VS Code.
...
- **[Allucination Detection](https://github.com/ToninoSas/mcpsuite):** Classificatore capace di determinare segnali di allucinazione all'interno di un LLM con funzioni agentiche di tool calling (Progetto tesi triennale).
